...
- Template IDs: commands 1-20 (17=HaltTrading, 18=ResumeTrading, 19=LoadSymbolEligibility, 20=LoadSymbolEligibilityBatch — APP-62 §G), pricing 50-57 (50=PriceRequest, 51=PriceResponse, 52=PriceValidationRequest, 53=PriceValidationResponse, 54=MarketDataTick, 55=MarketDataHeartbeat, 56=MarketDataSnapshotRequest, 57=MarketDataFeedStateChange), websocket 60-72, events 100-121 (117=TradingHaltActivated, 118=TradingHaltCleared, 119=RiskLimitChanged — APP-62 §D, 120=SymbolEligibilityLoaded — APP-62 §G, 121=OrderExpired — APP-62 §J), snapshots 200-213 (200=SnapshotTaken, 201=Account, 202=OrderBook, 203=RfqState, 204=Position, 205=IdGenerator, 206=EventSequencer, 207=reserved EventJournal, 208=Currency, 209=RiskLimit, 210=ClOrdIdDedup, 211=LastQuotedPrice — APP-62 §5, 212=AccountPosition — APP-62 §4, 213=SymbolEligibility — APP-62 §G+§I). Reserved: commands 21+, pricing 58-59, websocket 73-79, events 122+, snapshots 214+
- `RejectReasonEnum` extended for APP-62: `23=PositionLimitExceeded` (§4 — FIX tag 103 = 3), `24=PriceTooFarFromMarket` (§5 — FIX tag 103 = 99), `25=RiskLimitsNotLoaded` (§E fail-closed — FIX tag 103 = 3), `26=RegulatoryRestriction` (§G symbol-eligibility / Reg SHO — FIX tag 103 = 99), `27=FourEyesViolation` (§H LoadRiskLimit ingress dual-control — FIX tag 103 = 99). Mapping lives in `gateway/.../SbeToFixTranslator.java::mapRejectReason`. New `RiskCheckEnum` values 1=PositionLimit, 2=FatFinger, 7=RiskLimitsNotLoaded, 18=FourEyes — emitted on `OrderRejectedEvent.riskCheck` plus the `limitValue` / `projectedValue` breach-context fields (id=10110/10111).
