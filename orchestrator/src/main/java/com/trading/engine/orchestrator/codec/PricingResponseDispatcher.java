...
public final class PricingResponseDispatcher implements ControlledFragmentHandler {
  ...
  /**
   * Dispatches one inbound Aeron fragment from the pricing service after SBE header/body length
   * validation. Decodes the template ID and delegates to the appropriate handler method.
   *
